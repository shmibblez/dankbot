...
`;
    ...
    static onMessage(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (commands[1]) {
                case 'meme':
                    const [success, meme] = yield scraper_1.LittleHomie.getMeme();
                    if (!success) {
                    ...
                    scraper_1.LittleHomie.sendMemes(msg);
                    break;
                case 'fritar':
                    yield msg.reply('sorry homes, no esta listo todavia!');
                    break;
                default:
                case 'ayuda':
                    yield msg.reply(ElChingon.help);
                    break;
            }
        });
    }
