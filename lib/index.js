...
function deepFry(msg) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const m of messages) {
            ...
            url = (_d = (_c = m[1].embeds[0]) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.url;
            if (url) {
                name = 'epic';
                break;
            }
            url = (_f = (_e = m[1].embeds[0]) === null || _e === void 0 ? void 0 : _e.thumbnail) === null || _f === void 0 ? void 0 : _f.url;
            if (url) {
                name = 'epic';
                break;
            }
