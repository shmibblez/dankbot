...
function deepFry(msg) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (mimeType === 'image/gif') {
            ...
            yield deepFryImg({ url: url, filePath: imgPath, msg: msg });
        }
        else {
 ...
 */
function deepFryImg({ url, filePath, msg }) {
...
function deepfryGif({ url, filePath, msg }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return gifwrap_1.GifUtil.read(filePath, GifEncoder())
            .then((gif) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const frame of frames) {
                const friedJimp = gifwrap_1.GifUtil.shareAsJimp(jimp_1.default, frame).quality(20)
                    .contrast(0.7)
                    .posterize(1)
                    .pixelate(1.7);
                friedFrames.push(new gifwrap_1.GifFrame(friedJimp.bitmap));
            }
            yield gifwrap_1.GifUtil.write(filePath, friedFrames).then(gif => {
                console.log('gif:\n' + util_1.inspect(gif));
            }).catch(e => {
                console.error(e);
