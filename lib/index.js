...
function deepFry(msg) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (mimeType === 'image/gif') {
            ...
            yield deepFryImg2({ url: url, filePath: imgPath, msg: msg });
        }
        else {
...
function deepFryImg2({ url, filePath, msg }) {
    return __awaiter(this, void 0, void 0, function* () {
        const img = yield Canvas.loadImage(url);
        const canvas = Canvas.createCanvas(img.width, img.height);
        const ctx = canvas.getContext('2d');
        ctx.drawImage(img, 0, 0, img.width, img.height);
        console.log('img.src: ' + img.src);
        yield Caman(img.src, () => __awaiter(this, void 0, void 0, function* () {
            // @ts-ignore
            ...
            this.render(() => __awaiter(this, void 0, void 0, function* () {
                // @ts-ignore
                yield this.save(filePath);
            }));
        }));
        console.log('finished, file: ' + fs_1.readFile(filePath, (err, data) => {
            if (err) {
                console.log(err);
                return;
            }
