...
function deepFry(msg) {
    return __awaiter(this, void 0, void 0, function* () {
        const filter = (m) => { var _a; return m.attachments.size > 0 && ((_a = m.attachments.first()) === null || _a === void 0 ? void 0 : _a.url) != null; };
        console.log('getting messages');
        const messages = yield msg.channel.messages.fetch({ limit: 1 }, false);
